...
public class Term implements Comparable<Term> {
    private String query; // string of query
    private long weight; //  weight of query
    ...
    public Term(String query, long weight) {
        ...
        if (weight < 0) {
            throw new IllegalArgumentException("Illegal weight"); // corner case
        }
        this.query = query;
        this.weight = weight;
    }
    ...
    public static Comparator<Term> byPrefixOrder(int r) {
        if (r < 0) {
            throw new IllegalArgumentException("Illegal r"); // corner case
        }
    ...
    private static class PrefixOrder implements Comparator<Term> {
        int r; // total length of the prefix

        // Constructs a new prefix order given the prefix length.
        PrefixOrder(int r) {
            this.r = r; // initialize variable
        }
